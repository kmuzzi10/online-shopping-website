...
<html>
   <head>
        ...
        <link rel="shortcut icon" href="images/favicon-icon/25x25.png">
    
<style>body{background-image: url("https://wallpapercave.com/wp/wp7687509.png");}</style>
    </head>
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    <div class="login-form">
                        <h1 class="logo"><strong>Online Shopping</strong></h1>
                        <!-- Form -->
